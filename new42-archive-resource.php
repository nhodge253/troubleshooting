        ...
        <main class="page">
            ...
            <div id="resources-results" class="container grid grid-cols-12 mt-16 lg:gap-12 md:flex md:flex-col md:gap-0">
                <div class="col-span-3 mb-14 lg:col-span-4">
                    <div>
                    <form role="search" method="get" class="search-form search-form-side" action="http://localhost:8080/">
                        <label>
                ...
                <div id="records" class="col-span-8 lg:col-span-8">
                    ...
                    <?php
                            ...
                            use SearchWP\Query as SWP_Query;
...
$swp_query = new SWP_Query($search_query, $swp_args);

// Get the results
$results = $swp_query->get_results();

// Get the total number of results
$records_total = $swp_query->found_results;

// Log the results
error_log('SearchWP Results Count: ' . count($results));
error_log('SearchWP Total Found: ' . $records_total);

// Set up $records for compatibility with your existing code
$records = new WP_Query();
$records->posts = $results;
$records->post_count = count($results);
$records->found_posts = $records_total;
